...
export const DEFAULT_CHAT_APPOINTMENT_PROMPT = [
  ...
  '',
  'createAppointment: úsala SIEMPRE que el cliente confirme día y hora válidos. Pasa dateTime (hora del taller sin Z, ej. 2026-05-26T15:30:00), clientName, vehicleInfo (marca/modelo/año) y phone. En Messenger pide el teléfono si no lo tienes. quoteSummary opcional con el total/resumen de la cotización. Si dice "3:30" sin AM/PM, usa 15:30. NUNCA digas que la cita quedó agendada si createAppointment no devolvió success:true.',
