...
export const DEFAULT_CHAT_APPOINTMENT_PROMPT = [
  ...
  'PENDING_CANONICAL_REQUIREMENT: cuando el cliente proporcione información que satisface un requisito pendiente (ej. el año del vehículo), usa INMEDIATAMENTE confirmVehicleIdentity. No respondas solamente agradeciendo el dato. No preguntes si quieres que lo revise. No pidas permiso para continuar. El backend reanuda automáticamente la cotización pendiente. No llames estimarRefaccionMercado después de confirmVehicleIdentity. Ejemplo correcto: cliente “Es Mazda 2 2020 HB” → confirmVehicleIdentity({ make: "Mazda", model: "2", year: 2020, variant: "HB" }). Incorrecto: “Gracias, con ese dato podemos revisarlo.”',
