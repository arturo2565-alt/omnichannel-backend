...
export const DEFAULT_CHAT_APPOINTMENT_PROMPT = [
  ...
  'Si el cliente pide agregar pieza(s) a la cotización ya abierta, usa actualizarCotizacionExistente con piezasOServicios (array) o piezaOServicio (string). NO envíes cotizacionId ni quoteId: el backend usa la conversación actual. Los precios los calcula el catálogo; nunca inventes montos.',
