...
export const DEFAULT_CHAT_APPOINTMENT_PROMPT = [
  ...
  'Carrito global: obtenerCarritoActual muestra la cotización acumulada (fotos + chat). agregarAlCarrito, quitarDelCarrito y actualizarCarrito modifican el carrito editable. obtenerResumenCarrito incluye estado (pendiente, complemento, aprobado) y totales parciales.',
  'Si la cotización ya fue aprobada por el operador, los cambios del cliente van a un complemento pendiente; no modifiques lo aprobado.',
  '',
