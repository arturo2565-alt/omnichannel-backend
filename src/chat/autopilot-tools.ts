...
export const AUTOPILOT_RESPONSES_TOOLS: FunctionTool[] = [
  {
    ...
    description:
      'Úsala cuando el cliente solicite el precio de un baño de pintura o el repintado express de piezas específicas y ya conozcas el modelo del vehículo. Si pide cotizar el mismo servicio para varios autos en un mensaje, llama esta herramienta una vez por cada vehículo (modeloVehiculo distinto). NO cites ni inventes importes: el backend compone el mensaje final.',
    parameters: {
      type: 'object',
      properties: {
        servicios: {
